...
public class EllipticCurveAlgorithm {
    ...
    public static void main(String args[]) {
        ...
        long a = 5;
        Point pa = processor.multiply(a, algorithm.base);
        long b = 7;
        Point pb = processor.multiply(b, algorithm.base);
        // encode text = Pm
        byte[] encryptedText = algorithm.encrypt(bytes, pb, a);
        System.out.println("encrypted text bytes = "+ encryptedText);

        byte[] result = algorithm.decrypt(encryptedText, b);
        System.out.println("decyrpted text = " + new String(result));
